...
<template>
  <div
    id="Modal"
    class="fixed bottom-0 z-50 grid h-screen w-full place-items-center bg-black/50 backdrop-blur-md"
  >
    <div class="w-full max-w-[300px] rounded-lg border border-gray-600 bg-black p-2 text-white">
      <button
